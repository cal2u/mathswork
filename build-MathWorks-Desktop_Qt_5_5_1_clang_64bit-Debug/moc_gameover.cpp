...
QT_MOC_LITERAL(1, 9, 15), // "on_quit_clicked"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 16) // "on_retry_clicked"

    },
    "GameOver\0on_quit_clicked\0\0on_retry_clicked"
};
...
void GameOver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameOver::on_quit_clicked)) {
                *result = 0;
            }
        }
        {
            typedef void (GameOver::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameOver::on_retry_clicked)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void GameOver::on_quit_clicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void GameOver::on_retry_clicked()
{
